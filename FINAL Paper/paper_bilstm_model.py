# -*- coding: utf-8 -*-
"""paper_bilstm_model.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1WpSk1XPFA6w2N8VL4nAhYmera0TcRuus
"""
...
model_path = hf_hub_download(repo_id="RafidMehda/paper_doc2vec_model", filename="doc2vec_model")
doc2vec_model = Doc2Vec.load(model_path)

# Load pre-trained DistilBERT model and tokenizer
tokenizer = AutoTokenizer.from_pretrained("RafidMehda/paper_fined-distilBERT")
distilbert_model = AutoModel.from_pretrained("RafidMehda/paper_fined-distilBERT")
...
def evaluate(X, y, set_name):
    ...
    with torch.no_grad():
        ...
        report = classification_report(labels.numpy(), predicted.numpy(), target_names=['Non-Functional', 'Functional'])
...
# Make sure you have logged into Hugging Face account
notebook_login()

# Create a directory to store your model artifacts
os.makedirs('./paper_bilstm_model', exist_ok=True)

# Save your model and any required components
torch.save(model.state_dict(), './paper_bilstm_model/bi_lstm_model.pt')  # Save the Bi-LSTM model
torch.save(sentence_attention.state_dict(), './bilstm_model/sentence_attention.pt')  # Save the attention mechanism
tokenizer.save_pretrained('./paper_bilstm_model')  # Save the tokenizer
...
api.upload_folder(
    folder_path='./paper_bilstm_model',  # Path to your model files
    repo_id='RafidMehda/paper_bilstm_model',  # Name of your repository on Hugging Face
